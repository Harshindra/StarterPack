...
export default function ServicesPage({ onBackToHome, onNavigateToServices, onNavigateToHome }) {
  const allServices = [
    ...
    },
    {
      ...
      imageBgColor: "bg-gradient-to-br from-gray-800 to-gray-700 border border-blue-600/30",
      imageIcon: (
        <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 20 20">
    ...
    },
    {
      ...
      imageBgColor: "bg-gradient-to-br from-gray-800 to-gray-700 border border-red-600/30",
      imageIcon: (
        <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 20 20">
    ...
    },
    {
      ...
      imageBgColor: "bg-gradient-to-br from-gray-800 to-gray-700 border border-yellow-600/30",
      imageIcon: (
        <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 20 20">
          <path d="M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z"/>
        </svg>
      ),
      iconBgColor: "bg-gradient-to-r from-yellow-500 to-yellow-600",
    ...
    },
    {
      ...
      imageBgColor: "bg-gradient-to-br from-gray-800 to-gray-700 border border-indigo-600/30",
      imageIcon: (
        <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 20 20">
    ...
    },
    {
      ...
      imageBgColor: "bg-gradient-to-br from-gray-800 to-gray-700 border border-pink-600/30",
      imageIcon: (
        <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="py-20 pt-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-16">
            <p className="text-gray-300 mb-6">Ready to get started with our services?</p>
            <button className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold rounded-lg hover:from-green-600 hover:to-green-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
              Contact Us Today
