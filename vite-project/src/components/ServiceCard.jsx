  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20 group">
      ...
      <div className={`${isReversed ? 'lg:order-1' : 'lg:order-2'}`}>
        <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-6">{title}</h3>
        <p className="text-lg text-gray-600 mb-6 leading-relaxed">
          {description}
        </p>
        <ul className="space-y-3">
          {features.map((feature, index) => (
            <li key={index} className="flex items-center text-gray-600 hover:text-gray-900 transition-colors duration-300">
              <div className="w-5 h-5 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mr-3 flex items-center justify-center">
