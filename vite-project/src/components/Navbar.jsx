        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0">
            <div className="flex items-center">
              <div
                ...
                className="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg flex items-center justify-center transform transition-all duration-300 hover:scale-110 hover:rotate-3 hover:shadow-lg hover:shadow-blue-500/50 cursor-pointer group"
              >
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              <button
                onClick={onNavigateToHome}
                className={`${currentPage === 'home' ? 'text-white bg-gray-800' : 'text-gray-300'} hover:text-white hover:bg-gray-800 px-3 py-2 rounded-md text-sm font-medium transition-all duration-300 transform hover:scale-105`}
              >
                Home
              </button>
              <button
                onClick={onNavigateToServices}
                className={`${currentPage === 'services' ? 'text-white bg-gray-800' : 'text-gray-300'} hover:text-white hover:bg-gray-800 px-3 py-2 rounded-md text-sm font-medium transition-all duration-300 transform hover:scale-105`}
              >
                Services
              </button>
